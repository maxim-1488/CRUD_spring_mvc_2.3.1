package ru.maximkrylov.spring_mvc.config;
...
@ComponentScan("ru.maximkrylov.spring_mvc")
public class HibernateConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManager.setPackagesToScan("ru.maximkrylov.spring_mvc.model"); // указывается пакет в котором находяться сущьности
